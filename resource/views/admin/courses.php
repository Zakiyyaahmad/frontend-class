...
?>
 ...
 <main>
    <section class="header__container" style="margin: 10px;">
        <a href="<?php echo url("admin/courses/add"); ?>" class="header_image">
            <button class="contact__button button" style="margin-top: 10px;">+ Course</button>
        </a>
                ...
                <table class="table align-items-center mb-0" id="transactions">
                    <thead>
                        <tr>
                            ...
                            <!-- <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Students Taken Course</th> -->
                    ...
                    <tbody>
                       <?php foreach ($courses as $course) :?>
                            ...
                            <td class="align-middle text-start text-sm">
                                ...
                                <!-- <td class="align-middle text-center text-sm">
                                    <p class="text-secondary mb-0 text-sm">
                                        <?php echo $course->no_of_student;?>
                                    </p>
                                </td> -->
                                <td class="align-middle text-center text-sm">
                                    <p class="align-middle text-secondary mb-0 text-sm">
                                        <a href="<?php echo url('admin/courses/edit/'.$course->id); ?>" class="align-middle">
