    ...
    <section class="contact section" id="contact">
        <form id="form" action="" method="POST">
            <div style="column-gap: 5rem;" class="about__container bd-grid">
                <div>
                    <input type="text" name="name" placeholder="Student Name" class="contact__input">
                    <input type="text" name="admission_number" placeholder="Admission Number" class="contact__input">
                </div>
                <div>
                    <input type="text" name="email" placeholder="Email" class="contact__input">
                    <input type="password" name="password" placeholder="Password" class="contact__input">
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#form").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('admin/students/add'); ?>",
                data,
                dataType: "json",
                beforeSend: function() {
                    //Swal
