...
?>
 ...
 <main>
    <section class="header__container" style="margin: 10px;">
        ...
        <a href="<?php echo url("admin/timetable/manage/print/".$id); ?>" class="header_image">
                          ...
                          <td class="align-middle text-start text-sm">
                            ...
                            <td class="align-middle text-center text-sm">
                                <p class="align-middle text-secondary mb-0 text-sm">
                                    <a href="<?php echo url("admin/timetable/course/edit/".$generated_timetable->id); ?>" class="align-middle">
