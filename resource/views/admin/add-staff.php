        ...
        <form id="form" action="" method="POST">
            <div style="column-gap: 5rem;" class="about__container bd-grid">
                <div>
                    ...
                    <input type="text" name="rank" placeholder="Rank" class="contact__input">   
                </div>
                <div>
                    <input type="text" name="username" placeholder="Username" class="contact__input">
                    <input type="text" name="password" placeholder="Password" class="contact__input">
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#form").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('admin/staffs/add'); ?>",
                data,
                dataType: "json",
                beforeSend: function() {
                    //Swal
