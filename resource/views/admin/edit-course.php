    ...
    <section class="contact section" id="contact">
        <form id="form" action="<?php echo url('admin/courses/update/'.$id); ?>" method="POST">
            <div style="column-gap: 5rem;" class="about__container bd-grid">
                <div>
                    <input type="text" value="<?php echo $course->course_name; ?>" name="course_name" placeholder="Course Name" class="contact__input">
                    <input type="text" value="<?php echo $course->course_code; ?>" name="course_code" placeholder="Course Code" class="contact__input">
                    
                </div>
                <div>
                    <input type="text" value="<?php echo $course->level; ?>" name="level" placeholder="Level" class="contact__input">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#form").submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('admin/courses/update/'.$id); ?>",
                data,
                dataType: "json",
                beforeSend: function() {
                    //Swal
