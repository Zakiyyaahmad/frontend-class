...
<body class="about-us">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent ">
    <div class="container">
      <a class="navbar-brand  text-white " href="<?php echo url('') ?>" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom">
        VTU Project
      </a>
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 ps-lg-5" id="navigation">
        <ul class="navbar-nav navbar-nav-hover w-100">
          <li class="nav-item ms-lg-auto">
            <a class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1 mt-2 mt-md-0" href="<?php echo esc_url('login') ?>">
              <span class="nav-link-inner-text">My Account</span>
            </a>
          </li>
          <li class="nav-item my-auto ms-3 ms-lg-0">
            <a href="contact-us" class="btn btn-sm  bg-white  btn-round mb-0 me-1 mt-2 mt-md-0">Contact Us</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <p class="lead mb-4 text-white opacity-8">
              VTU App helps with Airtime top up and data bundle purchase for all networks in Nigeria.
            </p>
            <a href="<?php echo url('register') ?>" class="btn bg-white text-dark">Create Account</a>
            <a href="<?php echo url('login') ?>" class="btn bg-gradient-primary text-white">Sign In</a>
